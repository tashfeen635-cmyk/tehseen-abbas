const PORTFOLIO = [
  ...
  { src: "/images/Personal/660026014_17984237000976647_3032731924731393406_n.jpg", category: "personal" },
...
const EXPERIENCE = [
  { icon: "fa-globe-americas", title: "Senior Web Developer", description: "Capitalize on low hanging fruit to identify a ballpark value added activity to beta test. Override the digital divide with additional clickthroughs from DevOps. Nanotechnology immersion along the information highway will close the loop on focusing solely on the bottom line.", date: "March 2019 - Present", color: "cyan" },
  { icon: "fa-laptop-code", title: "Web Developer", description: "Capitalize on low hanging fruit to identify a ballpark value added activity to beta test. Override the digital divide with additional clickthroughs from DevOps. Nanotechnology immersion along the information highway will close the loop on focusing solely on the bottom line.", date: "December 2018 - March 2019", color: "yellow" },
  { icon: "fa-camera", title: "Junior Web Designer", description: "Capitalize on low hanging fruit to identify a ballpark value added activity to beta test. Override the digital divide with additional clickthroughs from DevOps. Nanotechnology immersion along the information highway will close the loop on focusing solely on the bottom line.", date: "July 2017 - December 2018", color: "green" },
  { icon: "fa-mountain", title: "Web Design Intern", description: "Capitalize on low hanging fruit to identify a ballpark value added activity to beta test. Override the digital divide with additional clickthroughs from DevOps. Nanotechnology immersion along the information highway will close the loop on focusing solely on the bottom line.", date: "September 2018 - June 2019", color: "blue" },
];
...
const AWARDS = [
  { date: "Apr 2017 - Mar 2018", title: "Google Analytics Certified Developer", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum mattis felis vitae risus pulvinar tincidunt. Nam ac venenatis enim. Aenean hendrerit justo sed." },
  { date: "Apr 2018 - Mar 2019", title: "Mobile Web Specialist - Google Certification", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum mattis felis vitae risus pulvinar tincidunt. Nam ac venenatis enim. Aenean hendrerit justo sed." },
];
...
const SETTINGS = {
  ...
  social: JSON.stringify({ facebook: "#", twitter: "#", linkedin: "#", github: "#" }),
  profileImage: "/logo/tehseen-abbas.jpg",
  logoImage: "/logo/logo.png",
  brandText: "BINARY-HUB",
};

export async function seedDb(sql) {
  ...
  for (const item of PORTFOLIO) {
    await sql`
      ...
      VALUES (${item.src}, ${item.category}, ${order++})
    `;
  }
  ...
  for (const e of EXPERIENCE) {
    await sql`
      ...
      VALUES (${e.icon}, ${e.title}, ${e.description}, ${e.date}, ${e.color})
    `;
  }

  for (const s of SKILLS) {
    await sql`INSERT INTO skills (icon, name, target) VALUES (${s.icon}, ${s.name}, ${s.target})`;
  }

  for (const a of AWARDS) {
    await sql`INSERT INTO awards (date, title, description) VALUES (${a.date}, ${a.title}, ${a.description})`;
  }

  for (const [k, v] of Object.entries(SETTINGS)) {
    await sql`INSERT INTO site_settings (key, value) VALUES (${k}, ${v})`;
  }
}
